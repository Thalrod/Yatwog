...
def main():
    ...
    program = ShaderProgram(vertpath="/home/thalrod/Bureau/Yet Another 2d Game (Yatwog)/test/test_vert.glsl", fragpath="/home/thalrod/Bureau/Yet Another 2d Game (Yatwog)/test/test_frag.glsl")
